...
| **DS_FREE_FN** | real free_function с doxy (жёсткий фильтр /tests/, Test*, run_*, _* prefixes) | ✅ **DoD 10.05** (Кодо main: 58 пар из 262 (после blacklist), core 45 + workspace 7; `dataset_v3` 4573→**4631** +1.3%; **+324% baseline = 4.24x**; **18 шаблонов финал**; 1683 уникальных классов) | — | DS_FIELDS_CMAKE ✅ |
