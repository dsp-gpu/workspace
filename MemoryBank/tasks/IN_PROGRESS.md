...
| **DS_FIELDS_CMAKE** | public_field (108 классов с ≥2 полями) + cmake_targets (31) | ✅ **DoD 10.05 ночь** (Кодо main: 139 пар = 108 public_fields + 31 cmake_target; `dataset_v3` 4434→**4573** +3.1%; **+318% от baseline = 4.2x**; ФИНАЛ 17 шаблонов; 1625 уникальных классов) | — | DS_CLASS_FACTS ✅ |
