...
| **DS_BALANCE** | [TASK_RAG_dataset_balance_2026-05-09.md](TASK_RAG_dataset_balance_2026-05-09.md) — добор под-представленных классов (count<5) → +200-400 пар, dataset_v4 ≥ 2400 | 📋 **для сестрёнки** (10.05 утро) | ~1-1.5 ч | ENRICH_TG ✅, CLAUDE_C4 ✅ |
...
| **DS** | [TASK_RAG_dataset_generation_for_qlora_2026-05-08.md](TASK_RAG_dataset_generation_for_qlora_2026-05-08.md) — dataset v3 для QLoRA | ✅ **DoD 9.05 + balance pass** (1093→2020→2221→**2662** пар, +143% от baseline; balance: +class_role 287, method_signatures без фильтра <3 (+155); 443→**724** классов, top-10 share 42.8%→35.7%; commit `e658d07`) | — | CTX1 ✅, CTX4 ✅ |
