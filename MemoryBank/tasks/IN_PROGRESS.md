...
| **DS_NS_FILES** | [TASK_RAG_dataset_namespace_files_2026-05-09.md](TASK_RAG_dataset_namespace_files_2026-05-09.md) — namespace_overview (22) + file_grouping (125) | ✅ **DoD 9.05 поздняя ночь** (Кодо main: +147 пар = `dataset_v3` 4253→**4398** (+3.4%); **+302% от baseline 1093** = 4x; ФИНАЛ — diminishing returns зафиксированы, остановка наращивания) | — | DS_DOC_RICH ✅ |
...
| **ARCH_FILES** | [TASK_RAG_arch_files_per_repo_2026-05-09.md](TASK_RAG_arch_files_per_repo_2026-05-09.md) — полные C2/C3/C4 файлы внутри 9 репо (`<repo>/.rag/arch/`) + DSP спец-шаблон + новый dataset шаблон `arch_levels` | 🚧 **я (Кодо main) 9.05 ночь** (доработка после CLAUDE_C4 minimal — Alex заметил placeholder в spectrum/CLAUDE.md) | ~3-4 ч | RAG_MAN ✅, RAG_CLAUDE_C4 ✅ |
