...
> **Источник обсуждения**: `~!Doc/CMake-GIT/Review_VariantA_Kodo_2026-04-18.md`
> **Исходные доки**: `~!Doc/CMake-GIT/1_…6_*.md`, `~!Doc/CMake-GIT/update_dsp.py`
...
**Где**: `E:\DSP-GPU\~!Doc\CMake-GIT\Patch_Flow.md` + копия в LocalProject/docs/
...
**Где**: `E:\DSP-GPU\~!Doc\CMake-GIT\update_dsp.py` → переместить в `E:\DSP-GPU\scripts\update_dsp.py`
...
| Ревью Варианта A (обсуждение дизайна) | ✅ готов | `~!Doc/CMake-GIT/Review_VariantA_Kodo_2026-04-18.md` |
| Исходные варианты 1-6 | ✅ готов (черновики) | `~!Doc/CMake-GIT/1_…6_*.md` |
| Patch_Flow.md | ⬜ todo (Фаза 4) | `~!Doc/CMake-GIT/Patch_Flow.md` |
| SMI100_Setup.md | ⬜ todo (Фаза 6) | `~!Doc/CMake-GIT/SMI100_Setup.md` |
...
- Обсуждение с Alex: `~!Doc/CMake-GIT/Review_VariantA_Kodo_2026-04-18.md` секции ⮕ Ответы Кодо
